...
<div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
    ...
    {!! Form::text('slug', '', ['class' => 'form-control','placeholder'=>$event->slug]) !!}
...
<div class="form-group {{ $errors->has('date_debut') ? 'has-error' : '' }}">
    ...
    {!! Form::input('date', 'date_debut', date("Y-m-d", strtotime($event->date_debut)), ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('date_fin') ? 'has-error' : '' }}">
    ...
    {!! Form::input('date','date_fin', date("Y-m-d", strtotime($event->date_fin)), ['class' => 'form-control']) !!}
